				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-12 col-12">
							...
							<h2 class="breadcrumb-title">Tableau de Bord</h2>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="container-fluid">
					...
					<div class="row">
								...
								<div class="dashboard-widget">
									<nav class="dashboard-menu">
										<ul>
											...
											<li>
												<router-link to="/Admin/users/userstg">
											...
											<li>
												<router-link to="/Admin/AffecStagiaires">
													<i class="fas fa-star"></i>
													<span>Affectation de stagiaires </span>
												</router-link>
											</li>
											<!-- <li>
											...
											<li>
												<router-link to="/Admin/ThemeMemoire">
													<i class="fas fa-share-alt"></i>
													<span>Thèmes de mémoire</span>
												</router-link>
											</li>
											<li>
												<router-link to="/Admin/users/usereditpass">
						...
						<div class="col-md-7 col-lg-8 col-xl-9">
													...
													<div class="dash-widget dct-border-rht">
														<div class="circle-bar circle-bar1">
															<div class="circle-graph1" data-percent="75">																
																<font-awesome-icon icon="fa-light fa-screen-users"/>
															</div>
														</div>
							...
							<div class="row">
								<div class="col-md-12">
									<h4 class="mb-4">Stagiaires</h4>
									<div class="appointment-tab">
									
										<!-- Appointment Tab -->
										<ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded">
											<li class="nav-item">
												<a class="nav-link active" href="#upcoming-appointments" data-toggle="tab">Affecté(e)s</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="#today-appointments" data-toggle="tab">En cours</a>
											</li> 
										</ul>
										<!-- /Appointment Tab -->
